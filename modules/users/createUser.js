...
createuser.post('/createuser',upload.single('resume_loc'),auth, function (req, res) {
    var user_data = {
                        ...
                        if(err){
                            ...
                            dbConnection.query(sqladd,[VALUES],function(err,aresult){
                                if(err){
                                    ...
                                    var VALUES = [[correl_id,technology.total_experience,technology.usa_experience,technology.marketing_email_id,technology.marketing_phone,technology.linkedIn_url,technology.resume_loc,technology.certificate_loc,technology.tags,technology.looking_for_job,technology.subject_tag,technology.non_subject_tag]];
